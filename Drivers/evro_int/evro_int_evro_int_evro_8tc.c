/**************************************************************************
File:               evro_int_evro_int_evro_8tc.c
Author:             Umputun
...
/****************************************************************************
function    : evro_int_evro_int_evro_8tcIosOpen
...
/****************************************************************************
function    : evro_int_evro_int_evro_8tcIosClose
...
{
    printf("EVRO 8TC Exit\n");
}

/****************************************************************************
function    : evro_int_evro_int_evro_8tcIosRead
...
)
{
    ...
    {
        modbus_set_response_timeout(ctx, &response_timeout);
        rc  = modbus_read_input_registers(ctx, 30019, 8, tab_reg);
        modbus_close(ctx);
        modbus_free(ctx);
...
/****************************************************************************
function    : evro_int_evro_int_evro_8tcIosCtl
